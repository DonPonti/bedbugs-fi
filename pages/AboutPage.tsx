        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-slate-800 p-8 rounded-lg shadow-md">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
            ...
            <ul>
              ...
              <li><strong>Community-Driven:</strong> The entire directory is maintained by community contributions made through a simple form. To ensure data quality, all submissions are reviewed by volunteers before being published.</li>
